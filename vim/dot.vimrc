...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
   ...
   "[ Buf switch | tab switch ] {{{2
      ...
      nmap <silent> <M-1> :confirm :b1<CR>
      nmap <silent> <M-2> :confirm :b2<CR>
      nmap <silent> <M-3> :confirm :b3<CR>
      nmap <silent> <M-4> :confirm :b4<CR>
      nmap <silent> <M-5> :confirm :b5<CR>
      nmap <silent> <M-6> :confirm :b6<CR>
      nmap <silent> <M-7> :confirm :b7<CR>
...
function! ShowText()
    ...
    " If word under cursor isn't a number
    if type(str2nr(num)) == 0 && str2nr(num) <= 0
        return -1
    endif
